  ...
  return (
    <div className="rounded-md border border-white/10 bg-black/40 overflow-hidden">
      <button
        ...
        className="flex w-full items-center justify-between px-3 py-2 text-left hover:bg-white/5 transition"
      >
        <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-slate-400">{title}</span>
        <svg
    ...
    <div className="mx-auto flex min-h-screen w-full max-w-none flex-col gap-4 px-3 py-3 sm:px-4 lg:px-8">
      ...
      >
        <section className={`space-y-3 rounded-md border border-white/10 bg-white/[0.03] p-3 backdrop-blur-sm ${
          ...
          {mode === "image" ? <>
            <Accordion title="Presets" defaultOpen={false}>
              <div className="grid grid-cols-2 gap-1.5">
                {IMAGE_PRESETS.map((preset) => (
                  <button
                    ...
                    className="rounded-sm border border-white/10 px-2 py-1.5 text-left transition hover:-translate-y-px hover:border-emerald-300/40 hover:bg-emerald-300/10 active:translate-y-0"
                  >
